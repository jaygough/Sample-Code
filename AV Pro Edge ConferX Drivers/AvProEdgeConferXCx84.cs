...
{ 
    ...
    public AvProEdgeConferXCx84(IPAddress ipAddress, ushort port = 23) : base(ipAddress, port, 8, 4) { SetupSwitcher(); }
    ...
    public AvProEdgeConferXCx84(ComPort comPort) : base(comPort, 8, 4) { SetupSwitcher(); }
